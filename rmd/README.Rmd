...
When 3DViz is launched (see __Use__), a file browser will appear. Inside the file browser should be three toy datasets. The user should select one of these datasets, plot the data, and export the figure as a test of proper configuration and function of the Shiny dashboard.
