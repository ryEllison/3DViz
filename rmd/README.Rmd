...
4. A file browser will appear, and the user can navigate to and select a __\*.csv__ dataset
    ...
    + The data file should be structured such that each column represents a vector of data (datasets meant for testing purposes can be referred to as examples, see __Test__)
...
When 3DViz is launched (see __Use__), a file browser will appear. Inside the file browser should be a __data__ directory in which are three toy datasets. The user should select one of these datasets, plot the data, and export the figure as a test of proper configuration and function of the Shiny dashboard.
